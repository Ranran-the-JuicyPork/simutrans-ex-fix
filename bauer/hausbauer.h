...
public:
	...
	static const building_desc_t* get_commercial(int level, uint16 time, climate cl, uint8 region, uint32 clusters, koord minsize, koord maxsize, bool allow_earlier = false );

	/// @returns a random industrial building matching the requirements.
	static const building_desc_t* get_industrial(int level, uint16 time, climate cl, uint8 region, uint32 clusters, koord minsize, koord maxsize, bool allow_earlier = false );

	/// @returns a random residential building matching the requirements.
	static const building_desc_t* get_residential(int level, uint16 time, climate cl, uint8 region, uint32 clusters, koord minsize, koord maxsize, bool allow_earlier = false );
